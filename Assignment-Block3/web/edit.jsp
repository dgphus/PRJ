                    ...
                    <div class="modal-content">
                        <form action="update">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    <label>Name</label>
                                    <input value="${detail.tensp}" name="tensp" type="text" class="form-control" required>
                                </div>
                                <div class="form-group">
                                    <label>Description</label>
                                    <input value="${detail.mota}" name="mota" type="text" class="form-control" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label>Price</label>
                                    <input value="${detail.dongia}" name="dongia" type="text" class="form-control" required>
                                </div>
                                <div class="form-group">
                                    <label>Image</label>
