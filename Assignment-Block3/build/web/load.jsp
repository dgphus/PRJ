                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        ...
                        <li class="nav-item">
                            <form class="d-flex" action="search">
                                <input class="form-control me-2" type="text" name="txtSearchValue" value="${SEARCH}">
                    ...
                    <c:forEach items="${List}" var="o">
                        <div class="col mb-5">
                            <div class="card h-100">
                                <!-- Product image-->
                                <img class="card-img-top" src="img/${o.hinhanh}" alt="..." />
                                <!-- Product details-->
                                ...
                                <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                    <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="detail?masp=${o.masp}">View options</a></div>
                                </div>
                            </div>
                        </div>   
                    </c:forEach>
